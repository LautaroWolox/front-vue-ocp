  ...
  <div ref="root" class="fm-date-picker ct-date-picker">
    ...
    >
      ...
      <svg viewBox="0 0 24 24" aria-hidden="true">
        <path d="M7 2v3M17 2v3M4 8h16M6 4h12a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2Z" />
      </svg>
    </button>

    <div v-if="open" class="fm-calendar ct-calendar" role="dialog" aria-label="Seleccionar fecha">
      <div class="fm-calendar-head ct-calendar-head">
        <button type="button" class="fm-calendar-nav ct-nav" aria-label="Mes anterior" @click="previousMonth">‹</button>
        ...
        <button type="button" class="fm-calendar-nav ct-nav" aria-label="Mes siguiente" @click="nextMonth">›</button>
      </div>

      <div class="fm-weekdays ct-weekdays">
...
const selectedDate = computed(() => normalizeDate(props.modelValue))
