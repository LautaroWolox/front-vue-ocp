<template>
  <div class="fm-panel-content fm-panel-content--accent fm-filters emulacion-filters">
    ...
    <div class="fm-actions fm-filter-actions emulacion-actions">
      <FmButton label="BUSCAR" icon="pi-search" :disabled="storeEmulacion.searching" @click="onSearch" />
      <FmButton label="LIMPIAR" icon="pi-align-left" variant="outline" :disabled="storeEmulacion.searching" @click="onClear" />
    </div>
  </div>
</template>
