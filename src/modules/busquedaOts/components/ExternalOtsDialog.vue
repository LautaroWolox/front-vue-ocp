...
.external-ots-dialog :deep(.p-dialog-title) {
  color: #263746 !important;
  font-size: 20px !important;
  font-weight: 500 !important;
}

.external-ots-dialog :deep(.p-dialog-header-actions) {
  gap: 4px !important;
}

.external-ots-dialog :deep(.p-dialog-maximize-button),
.external-ots-dialog :deep(.p-dialog-close-button) {
...
.external-ots-dialog :deep(.p-dialog-maximize-button:hover),
.external-ots-dialog :deep(.p-dialog-maximize-button:focus-visible) {
  background: #e9f7f8 !important;
  color: #008fa1 !important;
  box-shadow: none !important;
}

.external-ots-dialog :deep(.p-dialog-close-button:hover),
.external-ots-dialog :deep(.p-dialog-close-button:focus-visible) {
