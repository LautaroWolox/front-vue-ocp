...
.profile-only-loader :deep(.fm-typing-loader__box) {
  min-width: 300px;
  gap: 14px;
  padding: 30px 34px;
  border-radius: 22px;
...
.profile-only-loader :deep(.fm-typing-loader__image) {
  width: 156px;
  margin: 0;
}

.profile-only-loader :deep(.fm-typing-loader__title) {
  margin: 0;
  color: #008fa1;
  font-size: 24px;
  font-weight: 800;
...
.profile-only-loader :deep(.fm-typing-loader__box::after) {
  display: none;
}
